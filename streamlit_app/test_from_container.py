#!/usr/bin/env python3
"""
Test response parsing from inside Docker container
"""
import requests
import json
...
def test_langflow_response():
    """Test the actual API and response parsing from container"""
    print("🔍 Testing Langflow API response parsing from container...")
    
    url = "http://host.docker.internal:7860/api/v1/run/3f229440-4079-4ee6-bcd3-341accdd9761"
    
    payload = {
        "output_type": "chat",
        "input_type": "chat",
        "input_value": "Test từ container - cho tôi 2 tòa nhà"
    }
